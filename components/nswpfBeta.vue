<template>
  <div>
    <div class="text-nsw-brand-primary-blue">
      ...
      <span class="underline cursor-pointer" @click="showModal">feedback</span>
    ...
    >
      <div class="mt-7 mb-5 mx-2">
        ...
        <p class="mb-8">
          There are over 1300 roles across 60+ career pathways and this tool has
          been built to allow you to explore career pathways that are best
          suited to you.
        </p>
        ...
        <a href="mailto:pcc-careers@police.nsw.gov.au" class="underline">pcc-careers@police.nsw.gov.au</a>
      </div>
    </BaseModal>
  </div>
</template>
