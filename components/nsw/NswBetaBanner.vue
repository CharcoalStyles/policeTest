<template>
  <div class="p-4 md:p-6 flex flex-col md:flex-row items-start md:items-center xl:container text-sm">
    ...
    <span class="md:text-base">Please <a href="https://forms.office.com/Pages/ResponsePage.aspx?id=aHr5Hqvo7UShbbV5_i182IXKpD-zbx9LsP29enYEDpdUOUM4UkhFTVpWR1NDN0lBMFVSUThRRVhUMS4u" class="underline">leave your feedback</a> to help us improve the service.</span>
  </div>
</template>
